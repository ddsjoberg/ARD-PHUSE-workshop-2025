...
Or, you can make a copy of the following [RStudio Cloud instance](https://posit.cloud/spaces/627244/join?access_code=4hSWozyBep5aoNaasEbDhVg8iwtoRd7am4R4WPir) that has these packages pre-installed. A (free) Posit Cloud account is required.
