...
First, we compute the continuous summaries for AGE, BMI, HEIGHT, WEIGHT by TRT01A
...
Next, we compute the categorical summaries for AGEGR1, SEX, RACE, ETHNIC by TRT01A
